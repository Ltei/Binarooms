...
public class OGLRenderer implements GLSurfaceView.Renderer {
    ...
    private OGLShapeTriangle mTriangle;
    private OGLShapeSquare mSquare;
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        mTriangle = new OGLShapeTriangle();
        mSquare   = new OGLShapeSquare();
    }
    ...
    public void onDrawFrame(GL10 unused) {
        ...
        // Note that the mMVPMatrix factor *must be first* in order for the matrix multiplication product to be correct.
